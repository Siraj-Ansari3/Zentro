...
export const STATUS_CONFIG = {
  ...
  "REFUND_PENDING ": { label: "Refund Pending", cls: "bg-amber-400/10 text-amber-400 border-amber-400/20" },
  "REFUND_COMPLETED": { label: "Refund Completed", cls: "bg-emerald-400/10 text-emerald-400 border-emerald-400/20" },
  "EXCHANGE_DISPATCHED": { label: "Exchange Dispatched", cls: "bg-violet-400/10 text-violet-400 border-violet-400/20" },
  "EXCHANGE_DELIVERED": { label: "Exchange Delivered", cls: "bg-violet-400/10 text-violet-400 border-violet-400/20" },
